...
public class Graph extends javax.swing.JFrame {
	...
	private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {
		...
		JOptionPane.showMessageDialog(null,"Grafo aleatório gerado com sucesso");
	}
	...
	private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {
		...
		textResultado.append("Arestas da solução ótima: \n");
		...
		textResultado.append("Custo da Solução Ótima: " + k.getCusto()+"\n");
		textResultado.append("Número de podas: "+ b.quantpodas()+"\n");
		textResultado.append("Número de nós gerados: "+ b.quatnos()+"\n");
		textResultado.append("Tempo decorrido: "+(System.currentTimeMillis() - tempoInicio)+" ms");
	}

	//Inserção do número de vértices
	private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {
		String s = null;

		s = JOptionPane.showInputDialog("Inserir número de vértices", "Número de vértices (Exemplo: 4)");
	...
	//Inserção manual dos valores dos vértices
